...
public class VideoJuego5 {
    ...
    public static void inicializarEjercitos(HashMap<String, Soldado> e1, HashMap<String, Soldado> e2,
    ...
    public static void ordenamientoInsertionSort(HashMap<String, Soldado> ejercito) {
        ...
        for (int i = 1; i < keys.size(); i++) {
            ...
            while (j >= 0 && ejercito.get(keys.get(j)).getPuntosVida() < soldadoActual.getPuntosVida()) {
    ...
    public static void ordenamientoBubbleSort(HashMap<String, Soldado> ejercito) {
        ...
        for (int i = 0; i < n - 1; i++) {
            ...
            for (int j = 0; j < n - i - 1; j++) 
                if (ejercito.get(keys.get(j)).getPuntosVida() < ejercito.get(keys.get(j + 1)).getPuntosVida()) {
                    Soldado temp = ejercito.get(keys.get(j));
